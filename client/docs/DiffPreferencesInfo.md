...
**render_entire_file** | Option<**bool**> | Whether the whole file should be rendered instead of only the changed parts. | [optional]
**hide_empty_pane** | Option<**bool**> | Whether empty panes should be hidden. The left pane is empty when a file was added; the right pane is empty when a file was deleted. | [optional]
...
**responsive_mode** | Option<[**models::ResponsiveMode**](ResponsiveMode.md)> | The responsive-rendering mode of the diff view. Allowed values are NONE, SHRINK_ONLY and FULL_RESPONSIVE. | [optional]
...
**skip_unchanged** | Option<**bool**> | Whether files without changes are skipped when switching between files. | [optional]
