...
------------ | ------------- | ------------- | -------------
**content** | Option<**serde_json::Value**> | The new content of the file, sent as the raw request body. If not set, an empty file is created or the existing content is cleared. | [optional]
